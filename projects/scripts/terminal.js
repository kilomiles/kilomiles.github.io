// Modified code from https://codepen.io/AndrewBarfield/pen/LEbPJx.js

var ip = socket.gethostbyname(hostname) 
...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  return {
    init: function() {
      output('<p>' + new Date() + '</p><p>Enter "help" for a list of commands.</p>');
    },
    output: output
  }
};